...
import mask  # import mask.py to get mAP after each epoch
from models import *
...
def train():
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            is_coco = any([x in data for x in ['fruit.data', 'coco2014.data', 'coco2017.data']]) and model.nc == 80
            results, maps = mask.mask(cfg,
                                      data,
                                      batch_size=batch_size * 2,
